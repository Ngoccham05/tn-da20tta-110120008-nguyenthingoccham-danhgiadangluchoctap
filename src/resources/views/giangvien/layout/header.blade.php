      ...
      <ul class="list-unstyled topnav-menu float-right mb-0 mr-2">
        <li class="dropdown notification-list">
          <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
            <span class="d-none d-sm-inline-block ml-1 font-weight-medium">
              @if(Auth::guard('gv')->check())
                Giảng viên | {{ Auth::guard('gv')->user()->ten_dang_nhap }} 
              @endif
            </span>
          ...
          <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
            <!-- item-->
            <a href="/gv/ttcanhan" class="dropdown-item notify-item">
          ...
          <ul class="metismenu" id="side-menu">
            ...
            <li>
              ...
              <ul class="nav-second-level" aria-expanded="false">
                <li><a href="/gv/manhyeu">Năng lực</a></li>
                <li><a href="/gv/goiycaithien">Gợi ý cải thiện</a></li>
              </ul>
            </li>
