...
<div class="row">
  <div class="col-6">
    <div class="card card-body">
      ...
      <p class="card-text text-center p-3"><i class="fas fa-users" style="font-size: 20vh"></i></p>
  ...
  <div class="col-6">
    <div class="card card-body">
      ...
      <p class="card-text text-center p-3"><i class="fas fa-user" style="font-size: 20vh"></i></p>
      <button type="button" class="btn btn-success waves-effect waves-light py-1" onclick="formThemSV()" id="btnFormThemSV" data-toggle="modal" data-target=".modal-center">
        <i class="fas fa-plus mr-1 font-12"></i>Thêm
      </button>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" id="model-resize">
    <div class="modal-content">
        ...
        <div id="themSuaForm">
          <div class="d-flex mt-2">
            <label for="fileUpload" class="col-form-label p-1 pt-2 w-25">
              ...
              <a href="/excelmau/Diem_toan_khoa_lop.xls" id="mauNhieu" class="font-weight-light" download><i>Mẫu tại đây </i></a>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary waves-effect waves-light" id="btnThemNhSV" onclick="sendDataToPy()">Lưu</button>
        <button type="button" class="btn btn-primary waves-effect waves-light" id="btnThemSV" onclick="themSV()">Lưu</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
